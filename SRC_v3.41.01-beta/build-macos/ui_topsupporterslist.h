...
"}"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/icon/patreon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
    ...
    {
        TopSupportersList->setWindowTitle(QCoreApplication::translate("TopSupportersList", "Top Supporters @Waifu2x-Extension-GUI", nullptr));
